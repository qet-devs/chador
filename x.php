            ...
            if ($num_row > 0) {
                ...
                <form action="delete_backpack.php" method="post">
                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="">
                        <a data-toggle="modal" href="#backup_delete" id="delete" class="btn btn-danger" name=""><i
                        ...
                        while ($row = mysql_fetch_array($query)) {
                            ...
                            <tr id="del<?php echo $id; ?>">
                                ...
                                <td width="30"><a href="<?php echo $row['link']; ?>"><i
                                                class="icon-download icon-large"></i></a></td>
                            </tr>
                        <?php } ?>
                        </tbody>
                    </table>
