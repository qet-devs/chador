    ...
    if (unit == '' || location == '' || years == '' || months == '' || monrent == '' || payabledate == '' || utildep == '' || depmonths == '' || escper == '' || escint == '' || fitperiod == '' || lawyer == '' || usage == '' || commencedate == '' || depmonthscurrent == '') {
        ...
        $.ajax({
            ...
            data: {
                ...
                depmonthscurrent: depmonthscurrent
            },
            success: function (data) {
                $('#message').html(data);
            }
    ...
    if (name == '' || location == '' || address == '' || housetype == '' || name == '' || owner == '' || plot == '' || phone == '' || idno == '' || commision == '' || water == '' || paydate == '' || fid == '' || commencedate == '') {
        ...
        $.ajax({
            ...
            data: {
                ...
                sid: sid,
                sname: sname,
                depositheldby: depositheldby,
                utilitiesby: utilitiesby,
                paydate: paydate,
                commencedate: commencedate,
                water: water,
                email: email,
...
function addjournal() {
    ...
    if (lid == 628) {
        subid = $('#tenantname').val();
    }
    if (lid == 629) {
        subid = $('#suppliername').val();
    }
    if (lid == 741) {
        subid = $('#employee').val();
    }
    ...
    if (lid == '') {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#tenantname').val('');
                $('#suppliername').val('');
                $('#ledgername').parent().find('input:first').focus().val('');
                $('#transtype').val('');
                $('#amount').val('');
            }
        });
...
function entercreditreport() {
    ...
    if ((d1 == '' || d2 == '') && view == 0) {
        ...
        window.open("report.php?id=12.1&" + "\nd1=" + d1 + '&' + "\nd2=" + d2);
    }
}
...
function enterrefundsreport() {
    ...
    if ((d1 == '' || d2 == '') && view == 0) {
        ...
        window.open("report.php?id=12.2&" + "\nd1=" + d1 + '&' + "\nd2=" + d2);
    }
}
...
function enterinvvsrep(a) {
    ...
    if ((d1 == '' || d2 == '') && view == 0) {
        ...
        window.open("report.php?id=" + type + '&' + "\nd1=" + d1 + '&' + "\nd2=" + d2 + '&' + "\nname=" + name + '&' + "\nproperty=" + property + '&' + "\nmonth=" + month + '&' + "\nbalonly=" + balonly + '&' + "\ncode=" + a);
    }
}
...
function enterarchivedtenants() {
    ...
    if ((d1 == '' || d2 == '') && view == 0) {
        ...
        window.open("report.php?id=54.1&" + "\nd1=" + d1 + '&' + "\nd2=" + d2);
    }
}
...
function archiveletter(param) {
    swal({
            title: "Are you sure?",
            text: "The Letter will be Archived!",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#DD6B55",
            confirmButtonText: "Yes, Archive them!",
...
function addpropertydescription() {
    ...
    if (uid == '') {
        ...
        swal("Error", "Please state condition", "error");
    } else if (est_value == '') {
        swal("Error", "Enter the Estimated value!", "error");
    } else {
        $('#display').html('<img id="img-spinner" src="img/spin.gif" style="position:absolute; width:30px;top:25%; left:50%" alt="Loading"/>');
        $.ajax({
            url: 'data.php',
