    ...
    case 6:
        ...
        $columns = array(
            ...
            array(
                ...
                'formatter' => function ($d, $row) {
                    if ($d == 0) {
                        return '<b style="background:#ff3">Un-Assigned,Inactive</b>';
                    } else if ($d == 1) {
                        return '<b style="background:#0f6">Assigned,Active</b>';
                    } else if ($d == 2) {
                        return '<b style="background:#f00">Assigned,Inactive</b>';
                    }
    ...
    case 7:
        ...
        $columns = array(
            ...
            array(
                ...
                'formatter' => function ($d, $row) {
                    if ($d > date('Ymd')) {
                        return '<b style="background:#ff3">Open</b>';
                    } else if ($d == date('Ymd')) {
                        return '<b style="background:#0f6">Active</b>';
                    } else {
                        return '<b style="background:#f00">Closed</b>';
                    }
    ...
    case 8:
        ...
        $columns = array(
            ...
            array(
                ...
                'formatter' => function ($d, $row) {
                    if ($d == 1) {
                        return '<b style="background:#0f6">Open</b>';
                    } else {
                        return '<b style="background:#f00">Closed</b>';
                    }
    ...
    case 10:
        ...
        $columns = array(
            ...
            array(
                ...
                'formatter' => function ($d, $row) {
                    if ($d == 1) {
                        return '<b style="background:#0f6">Sent</b>';
                    } else {
                        return '<b style="background:#ff3">Pending</b>';
                    }
